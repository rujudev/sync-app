...
test('extrae correctamente atributos de títulos variados y compuestos', () => {
  const productos = [
    {
...
test('extrae y agrupa correctamente variantes Google Pixel y Samsung Galaxy S25 FE', () => {
  const productos = [
    {
...
test('extrae y agrupa correctamente variantes Samsung Galaxy S25 FE Black (Negro)', () => {
  const productos = [
    {
      title: 'Samsung Galaxy S25 FE 128GB Black (Negro)',
      price: 429.00,
...
test('extrae atributos correctamente de cada título S23 Ultra', () => {
  const productos = [
    {
      title: 'Samsung Galaxy S23 Ultra 512Gb Sky Blue (Azul)',
      price: 1200,
...
test('extrae atributos individuales del título S23 Ultra', () => {
...
test('agrupa variantes por modelo, capacidad y color S23 Ultra', () => {
  const productos = [
    {
      title: 'Samsung Galaxy S23 Ultra 512Gb Sky Blue (Azul)',
      price: 1200,
